/* =============================================================================
   ...
   Intercepts any request that did not match a defined route and returns a
   meaningful JSON error instead of the default Express HTML response.
   Must be registered AFTER all routes but BEFORE errorHandler in server.js.
   ============================================================================= */

/**
 * notFoundHandler – returns a 404 JSON response for undefined routes.
 *
